...
import { WhatsAppIcon, XTwitterIcon, FacebookIcon, LinkedInIcon } from '@/components/ProviderLogos';
      ...
      {isOpen && (
        <div className="absolute right-0 mt-2 w-56 bg-white rounded-2xl shadow-[0_10px_40px_-10px_rgba(0,0,0,0.15)] border border-slate-100 py-2 z-50 animate-in fade-in slide-in-from-top-2">
          ...
          <button
            ...
            className="w-full text-left px-4 py-2.5 flex items-center gap-3 hover:bg-slate-900/5 text-slate-700 hover:text-slate-900 transition-colors font-medium"
          >
